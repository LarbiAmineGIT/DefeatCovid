        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Formulaire de modification de données</h1>
					...
					<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Veuillez entez uniquement les données que vous souhaitez modifier </h6>
                        </div>
                        <div class="card-body">
                        
                        	<form method="post" class="user" action="../modifyparameters">
		          					<div class="form-group row">
		          						<div class="col-sm-6 mb-3 mb-sm-0">
		          							<input class="form-control form-control-user" name="nom1" placeholder="Nom" type="text">
		          						</div>
		          						
		          						<div class="col-sm-6 mb-3 mb-sm-0">
		          							<input class="form-control form-control-user" name="prenom1" placeholder="Prenom" type="text">
		          						</div>
		          					</div>
		          					
		          					<label for="start">Date de naissance :</label>

									<input class="form-control form-control user mb-3" type="date" id="start" name="date1"
									       value="2022-01-01"
		          					 ...
		          					 <div class="form-group row">
		          						<div class="col-sm-12 mb-3 mb-sm-0">
		          							<input class="form-control form-control-user" name="login1" placeholder="Adresse mail" type="email" >
		          						</div>
		          					</div>
		          					...
		          					<div class="form-group row">
		          						<div class="col-sm-6 mb-3 mb-sm-0">
		          							<input class="form-control form-control-user" name="password1" placeholder="Mot de passe" type="password" id="password">
		          						</div>
		          						
		          						<div class="col-sm-6 mb-3 mb-sm-0">
		          							<input class="form-control form-control-user" name="passwordconfirmation1" placeholder="Confirmation du mot de passe" type="password"  id="password_confirm1" oninput="check(this)">
		          						</div>
		          							<script language='javascript' type='text/javascript'>
			          							function check(input) {
			          								if (input.value != document.getElementById('password1').value) {
			          									input.setCustomValidity('Les mots de passes doivent être identiques');
			          								}else{
		          					...
		          					<div class="form-group row">
		          						<div class="col-sm-12 mb-3 mb-sm-0">
		          							<button type="submit" class="btn btn-primary btn-user btn-block"> Confirmer les changements </button>
		          						</div>
		          					</div>
