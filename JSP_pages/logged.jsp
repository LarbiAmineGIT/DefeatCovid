            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Acceuil </h1>
                   	...
                   	<form method="post" class="user" action="../notifyfriendsservlet">
                   		<div class="form-group row">
		          			<div class="col-sm-4 mb-3 mb-sm-0">
		          					<button type="submit" class="btn btn-danger btn-user btn-block"> Je suis atteint par le COVID-19 </button>
		          			</div>
		          		</div>
		 			</form>
					...
					<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Liste de vos notifications  </h6>
                        </div>
                        <div class="card-body">
                            <div class=>
                                   ...
                                   <%
									...
									if(mapnotif.size() == 0){
										...
										for (HashMap.Entry<Integer, ArrayList<Object>> entry : mapnotif.entrySet()) {
										    ...
										    out.println("<td> Je suis atteint par le covid ! "); 
										    out.println("</td>");
