            ...
            <div class="container px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="JSP_pages/login.jsp">Connexion</a></li>
                        <li class="nav-item"><a class="nav-link" href="JSP_pages/register.jsp">Inscription</a></li>
                        <li class="nav-item"><a class="nav-link" href="JSP_pages/help.jsp">FAQ</a></li>
                        <li class="nav-item"><a class="nav-link" href="JSP_pages/bean.jsp">BEAN</a></li>
                        <li class="nav-item"><a class="nav-link" href="../HelloServlet.java">BEAN</a></li>
            ...
            <div class="container px-lg-5">
                <div class="p-4 p-lg-5 bg-light rounded-3 text-center">
                    <div class="m-4 m-lg-5">
                        ...
                        <p class="fs-4"> DefeatCovid est une application créée pour aider à la lute contre la Covid-19</p>
